<?php $title = 'Location - Aura Malvern East'; include("includes/header.php"); ?>
<div class="container bg4 menu4">
	<div class="wrapper">
		<div class="menu"><?php require($DOCUMENT_ROOT . "includes/menu.php"); ?></div>
		<div class="content"><?php require($DOCUMENT_ROOT . "includes/pages/location.php"); ?></div>
	</div>
</div>
